    ...
    return (
        <div className="flex flex-col min-h-[calc(100vh-60px)] h-full">
            ...
            <div className="border p-4 rounded-lg mt-0 m-4 flex-grow grid grid-cols-[minmax(0,2fr),minmax(0,1fr)] gap-4">
                <div className={`bg-blue-gray p-4 rounded-lg flex flex-col h-full ${user.rol === 'docente' ? 'col-span-2' : ''}`}>
                    ...
                    {user.rol === 'docente' && (
                        <div className="flex justify-end items-center mt-2">
                            <label className="text-xm font-semibold font-Montserrat mr-2">Fecha de entrega:</label>
