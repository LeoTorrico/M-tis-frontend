...
const ClasesPrueba = () => {
  ...
  useEffect(() => {
    ...
    const fetchGestiones = async () => {
      try {
        const response = await axios.get("https://backend-tis-silk.vercel.app/gestiones/", {
          headers: {
            Authorization: `Bearer ${token}`,
          },
        });
  ...
  const handleCrearClase = async () => {
    ...
    try {
      ...
      const response = await axios.post("https://backend-tis-silk.vercel.app/clases/crear", requestBody, {
          headers: {
              Authorization: `Bearer ${token}`,
          },
      });
...
const handleUnirseClase = async () => {
  ...
  try {
      ...
      const response = await axios.post(
          "https://backend-tis-silk.vercel.app/clases-estudiante/unirse-clase",
          requestBody,
          {
              headers: {
                  Authorization: `Bearer ${token}`,
