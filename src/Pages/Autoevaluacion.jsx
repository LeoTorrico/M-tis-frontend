...
const Autoevaluacion = () => {
  ...
  const estudiante = grupoData?.estudiantes?.find(
    (integrante) => integrante.codigo_sis === user.codigoSis
  );
      ...
      <div className="border border-black rounded-lg p-6 mb-6 overflow-x-auto">
        ...
        <div className="flex items-center mb-4">
          ...
          <h1 className="text-lg font-bold">
            Calificación a usted mismo bajo honestidad
          </h1>{" "}
        </div>{" "}
          ...
          <div>
            ...
            {estudiante ? (
              <div className="mb-2">
                ...
                <input
                  type="text"
                  value={`${estudiante.nombre_estudiante} ${estudiante.apellido_estudiante} (${estudiante.rol})`}
                  readOnly
                  className="bg-[#D1DDED] rounded-lg p-2 w-full"
                />{" "}
              </div>
            ) : (
              <div>No se encontró al estudiante.</div>
            )}
          </div>
          <div>
            ...
            <div className="flex flex-col space-y-2">
              {" "}
              {estudiante ? (
                <div className="relative" onClick={() => openRubricModal(0)}>
                  {" "}
                  <input
                    type="text"
                    value={
                      estudiante.score !== undefined ? estudiante.score : "/..."
                    }
                    readOnly
